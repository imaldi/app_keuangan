...
TrxGetParams trxGetParamsFromJson(String str) =>
    TrxGetParams.fromJson(json.decode(str));
...
class TrxGetParams with _$TrxGetParams {
  ...
  factory TrxGetParams.fromJson(Map<String, dynamic> json) =>
      _$TrxGetParamsFromJson(json);
}
